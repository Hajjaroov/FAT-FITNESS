...
- Token issuing, login, refresh, resend verification, and real email delivery are not implemented yet.

Next user/auth step:

- Implement resend verification using the existing hashed email verification token storage.
