...
export const communityCopy = {
  en: {
    ...
    posts: {
      ...
      cancelLabel: "Cancel",
      deleteConfirmText: "Really delete this thread?",
      deleteConfirmLabel: "Yes, delete",
      deletePendingLabel: "Deleting...",
      editErrorFallback: "Could not save the changes. Please try again.",
      deleteErrorFallback: "Could not delete. Please try again.",
    },
    reports: {
      eyebrow: "Report",
    ...
    comments: {
      ...
      savePendingLabel: "Saving...",
      cancelLabel: "Cancel",
      deleteConfirmText: "Really delete this reply?",
      deleteConfirmLabel: "Yes, delete",
      deletePendingLabel: "Deleting...",
      editErrorFallback: "Could not save the changes. Please try again.",
      deleteErrorFallback: "Could not delete. Please try again.",
  ...
  de: {
    ...
    posts: {
      ...
      deleteConfirmText: "Thread wirklich löschen?",
      deleteConfirmLabel: "Ja, löschen",
      deletePendingLabel: "Wird gelöscht...",
      editErrorFallback: "Änderungen konnten nicht gespeichert werden. Bitte versuche es erneut.",
      deleteErrorFallback: "Löschen ist fehlgeschlagen. Bitte versuche es erneut.",
    },
    reports: {
      eyebrow: "Melden",
    ...
    comments: {
      ...
      savePendingLabel: "Wird gespeichert...",
      cancelLabel: "Abbrechen",
      deleteConfirmText: "Antwort wirklich löschen?",
      deleteConfirmLabel: "Ja, löschen",
      deletePendingLabel: "Wird gelöscht...",
      editErrorFallback: "Änderungen konnten nicht gespeichert werden. Bitte versuche es erneut.",
      deleteErrorFallback: "Löschen ist fehlgeschlagen. Bitte versuche es erneut.",
